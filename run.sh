...
then
    startConfiguration
    #some shit
    sed -i -e 's/localhost/mysql-bitrix/g' /home/bitrix/www/bitrix/.settings.php
    sed -i -e 's/localhost/mysql-bitrix/g' /home/bitrix/www/bitrix/php_interface/dbconn.php    
